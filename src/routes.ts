...
// --- PRODUCT --- //
/* import { SearchProductsController } from './controllers/filter/CategoryProductsController';

router.get("/products/busca", (req, res, next) => {
  Promise.resolve(searchProductsController.handle(req, res)).catch(next);
}); */
